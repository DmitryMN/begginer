...
export const User = React.memo(({id, first_n, last_n, email, avatr, inviteUsers, invite}) => (
  <li>
    <div>
      <img className="avatar" src={avatr} alt="User" />
      <div>
        <h3>{`${first_n} ${last_n}`}</h3>
        <p>
    ...
    <img onClick={() => {inviteUsers(id)}} className="action" src={`/assets/${invite.includes(id)? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
));
